...
| 80 | HTTP | TCP, UDP, SCTP | Hypertext Transfer Protocol (HTTP) uses TCP in versions 1.x and 2. <br><br>HTTP/3 uses QUIC, a transport protocol on top of UDP |
...
| 138 | NetBIOS-dgs | TCP, UDP | NetBIOS Datagram Service |
